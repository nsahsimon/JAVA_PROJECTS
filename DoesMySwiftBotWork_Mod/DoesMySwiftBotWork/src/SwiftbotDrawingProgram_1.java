...
public class SwiftbotDrawingProgram {
    ...
    private static final double WHEEL_DISTANCE = 13.0;
    private static final double LOW_SPEED = 100; 
    private static final double HIGH_SPEED = 100; 
    private static final double SPEED_FACTOR = 1; // Proportionality factor that converts the speed of the wheels to rotations per minute (rpm)
    ...
    private static double calculateTime(double distance, double speed) {
        ...
        double time =  8 * distance / ( 39 * Math.PI);
        return time;
    }
